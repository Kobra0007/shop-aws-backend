...
import { type IProductsDBController } from './index';

const { DYNAMO_PRODUCTS_TABLE_NAME, DYNAMO_STOCKS_TABLE_NAME, DYNAMO_STOCKS_PRODUCT_ID_INDEX } =
  process.env;

const createDbClient = () => new DynamoDBClient({});

const productsDynamoDBController: IProductsDBController = {
...
export default productsDynamoDBController;
